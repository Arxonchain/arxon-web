...
import arxonCoin2 from "@/assets/arxon-coin-2.webp";
import arxonCoin4 from "@/assets/arxon-coin-4.webp";
...
const FallingCoins = () => {
  const coins = Array.from({ length: 10 }, (_, i) => ({
    ...
    delay: i * 0.7,
    duration: 6 + (i % 4),
    size: i % 2 === 0 ? "w-20 h-20" : "w-14 h-14",
    img: i % 2 === 0 ? arxonCoin2 : arxonCoin4,
  }));
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      {coins.map((coin) => (
        <motion.img key={coin.id} src={coin.img} alt=""
          className={`absolute ${coin.size} opacity-[0.07]`}
          style={{ left: coin.left, top: "-60px" }}
          animate={{ y: ["0vh", "110vh"], rotate: [0, 360], opacity: [0, 0.07, 0.07, 0] }}
          ...
          <div className="pt-28 pb-20 px-6">
            <div className="max-w-[600px] mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <motion.button onClick={() => navigate("/ambassadors/portal")}
      ...
      <div className="relative z-10">
        ...
        <div className="pt-28 pb-20 px-6">
          <div className="max-w-[700px] mx-auto">
            ...
            <motion.form onSubmit={handleSubmit} initial={{ opacity: 0, y: 30 }}
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input className={inputClass} placeholder="Your Arxon app account ID"
                    value={form.arxon_account_id} onChange={e => updateField("arxon_account_id", e.target.value)} />
                </div>
                <div>
                  <label className="text-white/70 text-xs font-medium mb-1.5 block">Twitter (X) Account Link *</label>
                  <input className={inputClass} placeholder="https://x.com/yourhandle"
                    value={form.x_handle} onChange={e => updateField("x_handle", e.target.value)} />
                </div>
              </div>

              <div>
                <label className="text-white/70 text-xs font-medium mb-1.5 block">Country *</label>
                <input className={inputClass} placeholder="Your country"
              ...
              <div>
                ...
                <input className={inputClass} placeholder="Optional"
                  value={form.previous_experience} onChange={e => updateField("previous_experience", e.target.value)} />
              </div>
