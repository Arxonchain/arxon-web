...
import { Globe, Smartphone, ArrowRight, Download, ArrowLeft, Zap, Shield, Clock } from "lucide-react";
...
const MiningChoice = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      note: { icon: <AppleIcon size={11} className="text-white/25"/>, text: "No release date set — follow @arxoninfra on X for updates", cls: "bg-white/[0.02] border-white/[0.05] text-white/25" },
      hover: "",
    },
  ];
