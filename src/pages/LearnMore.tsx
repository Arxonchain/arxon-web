      ...
      <motion.div initial={{opacity:0,y:40,filter:"blur(8px)"}} animate={{opacity:1,y:0,filter:"blur(0px)"}} transition={{duration:0.7}}>
        ...
        <div className="relative pt-28 pb-4 px-6 max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="font-mono text-[9px] text-[#7c93c3]/50 tracking-widest">ARXON / PROTOCOL_DOCS</span>
          </div>
          <h1 className="text-[clamp(28px,4vw,48px)] font-bold text-white mb-2">What Arxon is <span className="text-[#7c93c3]">Building</span></h1>
          <p className="text-white/35 text-sm max-w-[480px]">The full technical picture — features, use cases, roadmap, and consensus architecture.</p>
        </div>
        ...
        <section className="relative bg-[#09090b] py-24 md:py-32 overflow-hidden">
          ...
          <div className="max-w-[900px] mx-auto px-6">
            <motion.div initial={{opacity:0,y:28}} whileInView={{opacity:1,y:0}} viewport={{once:true}}
              className="relative bg-[#0a0a0d] border border-[#7c93c3]/20 rounded-2xl overflow-hidden p-12 text-center">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center gap-4 mb-6">
                  ...
                  <span className="font-mono text-[9px] text-[#7c93c3]/45 tracking-widest">PARTNERSHIP_CHANNEL.open</span>
                  <div className="h-px w-12 bg-[#7c93c3]/25"/>
                </div>
                <h2 className="text-[clamp(24px,3.5vw,40px)] font-bold text-white mb-4">
                  Want to <span className="text-[#7c93c3]">Build With Us?</span>
                </h2>
                <p className="text-white/35 text-sm leading-relaxed max-w-[500px] mx-auto mb-8">
