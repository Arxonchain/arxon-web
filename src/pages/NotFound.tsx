  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-6 overflow-hidden">
      ...
      <motion.div initial={{opacity:0,y:24}} animate={{opacity:1,y:0}} className="text-center max-w-[480px] w-full">
        <div className="relative bg-[#0a0a0d] border border-[#7c93c3]/20 rounded-2xl overflow-hidden p-10">
          <div className="absolute top-0 left-0 w-4 h-4 border-t border-l border-[#7c93c3]/30"/>
          <div className="absolute top-0 right-0 w-4 h-4 border-t border-r border-[#7c93c3]/30"/>
          <div className="absolute bottom-0 left-0 w-4 h-4 border-b border-l border-[#7c93c3]/30"/>
          <div className="absolute bottom-0 right-0 w-4 h-4 border-b border-r border-[#7c93c3]/30"/>
          ...
          <p className="text-white/40 text-sm mb-8">The requested route does not exist in this protocol.</p>
