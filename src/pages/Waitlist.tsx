    ...
    <div className="min-h-screen bg-[#09090b] overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6">
        <motion.div initial={{opacity:0,scale:0.95}} animate={{opacity:1,scale:1}}
          className="relative max-w-[480px] w-full bg-[#0a0a0d] border border-[#7c93c3]/20 rounded-2xl overflow-hidden p-10 text-center">
          ...
          <p className="text-white/40 text-sm mb-8">You'll be notified as soon as ARX mining goes live. Stay close to our channels for updates.</p>
          ...
          <div className="grid md:grid-cols-[1fr_460px] gap-10 items-start">
            ...
            <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}}>
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="font-mono text-[9px] text-[#7c93c3]/50 tracking-widest">WAITLIST.register</span>
              </div>
              <img src={arxonLogo} alt="ARXON" className="h-7 mb-5 opacity-80"/>
              <h1 className="text-[clamp(28px,4vw,44px)] font-bold text-white mb-3">Join the Mining <span className="text-[#7c93c3]">Waitlist</span></h1>
              <p className="text-white/40 text-sm mb-8 max-w-[400px]">Be among the first to start mining $ARX tokens. Enter your details to secure your spot.</p>
              ...
              <div className="relative bg-[#0a0a0d] border border-white/[0.06] rounded-2xl overflow-hidden">
                ...
                <div className="flex items-center gap-2 px-6 py-3.5 border-b border-white/[0.05]">
                  ...
                  <span className="font-mono text-[9px] text-white/20">waitlist_registration.form</span>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                  {/* Step 1: Follow */}
                  <div className={`relative rounded-xl p-4 border transition-all ${hasFollowed?"border-emerald-400/20 bg-emerald-400/[0.03]":"border-[#7c93c3]/15 bg-[#7c93c3]/[0.02]"}`}>
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        <div className="font-mono text-[9px] text-white/25 mb-0.5 tracking-widest">STEP_01 / FOLLOW_REQUIRED</div>
                      ...
                      {!hasFollowed?(
                        <div className="space-y-2">
                          <motion.button type="button" onClick={handleFollowClick} whileHover={{scale:1.01}} whileTap={{scale:0.98}}
                            className="w-full flex items-center justify-center gap-2 py-3 rounded-lg border border-white/[0.08] text-white/60 font-mono text-xs hover:border-[#7c93c3]/25 hover:text-white/80 transition-all">
                  ...
                  <div className="space-y-3">
                    <div className="font-mono text-[9px] text-white/25 tracking-widest">STEP_02 / YOUR_DETAILS</div>
                    <div>
                      <label className="font-mono text-[9px] text-white/30 block mb-1.5 tracking-widest">FULL_NAME</label>
                  ...
                  <p className="font-mono text-[9px] text-white/20 text-center">You'll be notified when ARX mining becomes available.</p>
                </form>
              </div>
            </motion.div>
            ...
            <motion.div initial={{opacity:0,x:20}} animate={{opacity:1,x:0}} transition={{delay:0.15}} className="hidden md:block">
              <div className="relative rounded-2xl overflow-hidden border border-white/[0.06]">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="font-mono text-[9px] text-[#7c93c3]/60 mb-1">MINING_STATUS</div>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-[#7c93c3] animate-pulse"/>
