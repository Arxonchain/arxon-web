  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-[#09090b]/85 backdrop-blur-xl border-b border-white/[0.06] shadow-[0_4px_30px_rgba(0,0,0,0.4)]"
          : "bg-transparent"
      }`}
    >
      ...
      <div className="absolute top-0 left-0 right-0 h-[1px] overflow-hidden">
        <motion.div
          className="h-full w-full bg-gradient-to-r from-transparent via-[#7c93c3]/40 to-transparent"
          animate={{ x: ["-100%", "100%"] }}
      ...
      <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between h-16">
        ...
        >
          ...
          <motion.div
            className="absolute -inset-2 rounded-lg bg-[#7c93c3]/0"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="md:hidden bg-[#09090b]/95 backdrop-blur-xl border-t border-white/[0.06]"
          >
            <div className="px-6 py-4 flex flex-col gap-1">
              {links.map((l, i) => (
                ...
                >
                  <motion.span
                    className="w-1 h-1 rounded-full bg-[#7c93c3]/50"
              ...
              <motion.button
                ...
                className="btn-shimmer mt-3 bg-[#7c93c3] text-white text-sm font-bold px-4 py-2.5 rounded-lg text-center flex items-center justify-center gap-2"
              >
